...
// turn this into a file that can be imported for its function, be clear that it will always input as a string 
// & students will have to alter the string if they want input